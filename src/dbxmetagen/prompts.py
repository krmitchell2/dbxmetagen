            ...
            "pi": [
                {
                    ...
                    4. Column-level classification priority: Classify columns based on their intrinsic content primarily, and secondarily by their context. Any of the 18 HIPAA identifiers should be classified as PHI regardless of whether they appear in a healthcare, financial, or retail context. Medical data without embedded identifiers should be classified as medical_information. Only use PHI for columns that either: (a) are healthcare-specific identifiers, or (b) contain medical information or freeform text with embedded patient identifiers.
                    ...
                    6. Freeform medical text with embedded identifiers: Clinical notes, physician notes, comments, details, reason, or any freeform text should be classified as PHI. For example, "Patient John Smith reports..." makes the entire text field PHI.
                    ...
                    8. The medical_information type should be used for medical text that has clearly been de-identified or contains no embedded identifiers: diagnosis codes, medication names, lab test names, procedure codes, created at or updated at columns in phi tables, or structured lab result values. These become part of PHI at the table level when combined with PII, but at the column level they are medical_information.
