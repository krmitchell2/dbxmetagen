            ...
            "pi": [
                {
                    ...
                    6. Freeform medical text with embedded identifiers: Clinical notes, physician notes, comments, details, or any freeform text should be classified as PHI. For example, "Patient John Smith reports..." makes the entire text field PHI.
